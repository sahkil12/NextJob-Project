...
import { FaUserPlus, FaFileUpload, FaBriefcase, FaHandshake } from "react-icons/fa";
const HowItWork = () => {
    const steps = [
    {
      id: 1,
    ...
    {
      id: 2,
      icon: <FaFileUpload size={45} className="text-4xl text-secondary mx-auto" />,
      title: "Upload Resume",
    ...
    return (
        <div className="w-full bg-accent/15">
           <div className="md:w-[80%] mx-auto  my-10 py-8 rounded-xl border-neutral-200 pops text-center ">
           <div className="space-y-7">
             <h2 className="text-4xl flex justify-center gap-1 md:text-5xl font-bold text-accent">How It <span className="text-secondary">Works</span> <VscWorkspaceTrusted /></h2>
            <p className="text-lg text-base-200 font-medium">Follow these 4 simple steps to land your dream job.</p>
           </div>
   ...
   {step.icon}
            ...
            <h3 className="text-2xl font-semibold mt-4 text-black">{step.title}</h3>
