...
const Profile = () => {
	...
	<div className="space-y-4 text-center divide-y dark:divide-gray-300">
		<div className="my-3 text-center space-y-2">
			...
			<p className="mx-auto pb-5 text-xs sm:text-base">{user.email}</p>
		</div>
		<div className="flex justify-center pt-2 space-x-4 align-center">
			<a rel="noopener noreferrer" href="#" aria-label="GitHub" className="p-2 rounded-md">
				<svg viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 fill-current">
			...
			<a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md">
				<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7 fill-current">
